...
public class FactionManager implements SuggestionProvider<String> {
	...
	public CompletableFuture<Suggestions> getSuggestions(final CommandContext<String> context, final SuggestionsBuilder builder) throws CommandSyntaxException {
		String base = builder.getRemainingLowerCase();
		for(Faction faction : factions.values()) {
			if(base.startsWith(faction.id))
